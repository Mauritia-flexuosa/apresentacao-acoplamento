...
- Parte do princípio da existência de estados alternativos de funcionamento;

-  Estados alternativos podem ocorrer sob as mesma
s condições ambientais;

- Variável de estado (característica estrutural ou funcional que dá identidade ao sistema) tem resposta não linear à mudanças nas condições do sistema.
...
```
---
## Outra forma de identificar os mesmos estados alternativos
...
## A tese tem por objetivo geral entender a resiliência da vegetação neotropical à mudanças nos regimes de chuva com base na funcionalidade da vegetação.

---
class: top, left

# Relação da estrutura com a funcionalidade

- Estudos sugerem que a funcionalidade da vegetação seja correspondente à estrutura. (*Xu et al 2015; Xu et al 2016; Xu et al 2018.*)
...
- As respostas fenológicas (acoplamento, sd do evi, média do evi, amplitude do evi) dos tipos de vegetação na escala continental dependem do regime de precipitação (MAP, MSI, cv) como a estrutura do dossel depende?
...
- Funcionalidade e a resposta da vegetação à perturbações depende dos atributos funcionais (*Barros et al 2019 - New Phytologist*).
...
Pergunta: A resiliência de savanas e de matas de galeria ao fogo e à seca são determinadas pela hidrologia, pela riqueza de espécies, pela média ou pela variação da comunidade nos atributos funcionais relacionados com resistência ao fogo e à seca?
...
<img width="33%" src="https://www.embrapa.br/image/journal/article?img_id=43816247&t=1559587291923"/>
<img width="33%" src="https://www.embrapa.br/image/journal/article?img_id=43816249&t=1559587292941"/>
Da esquerda para a direita, respectivamente, imagem de: Sr Gerson (proprietário da área); Bruno Walter (EMBRAPA); José Felipe Ribeiro (EMBRAPA)
...
knitr::include_graphics("http://www.engesat.com.br/wp-content/uploads/Landsat-8-nas-bandas-3-2-1-PAN-processamento-FuzeGO.png")
```
...
<img width="32%" src="img/strategy2.png"/>
<img width="32%" src="img/guiga.png"/>
...
### Profundidade da raiz (Fan et al 2017)

```{r fig0002, include=TRUE, echo=FALSE, out.width="65%", fig.align='center'}
knitr::include_graphics("img/root_depth.png")
```
...
### Profundidade do lençol (Fan et al 2017)

```{r fi02, include=TRUE, echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("img/water_table_depth.png")
```
...
### Cobertura do dossel (densiômetro)

```{r tc, include=TRUE, echo=FALSE, out.width="70%", fig.align='center'}
knitr::include_graphics("img/SM_7.png")
```
