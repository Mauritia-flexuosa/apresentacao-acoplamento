...
- Landsat 8 OLI (Abril 2013 - Junho 2018);

--

- CHIRPS (mesmo período).
...
- Magnitude do acoplamento = valor absoluto do acoplamento;

--

- Cálculo do atraso nas respostas andando de zero a seis meses para trás a precipitação;
