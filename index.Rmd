...
```{r fig23434, include=TRUE, echo=FALSE, out.width="45%", fig.align='center'}
knitr::include_graphics("img/final fig.jpeg")
```

<img width="32%" src="img/final fig.jpeg"/>
<img width="33%" src="img/gallery1.png"/>
<img width="33%" src="img/gallery2.png"/>
