...
### Entretanto, algumas plantas são tolerantes ao alagamento
...
- Deciduidade depende do solo;

- Ontongenia têm papel importante na estruturação da vegetação e nas respostas à seca.
...
```{r fig23434, include=TRUE, echo=FALSE, out.width="75%", fig.align='center'}
knitr::include_graphics("img/final fig.jpeg")
```
